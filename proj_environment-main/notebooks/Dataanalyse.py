...
images_dir = project_dir/ "resources" / "images" #Dir til images
...
if __name__ == "__main__":  # Koden kjøres bare i dette skriptet:
    ...
    plot_histogram(NO2,'orange','NO2',20)
    plot_histogram(PM25,'darkgrey','PM2.5',20)
    plot_histogram(PM10,'plum','PM10',20)

    plot_histogram(data['NO2'], 'orange', 'NO2',50)
    plot_histogram(data['PM2.5'], 'darkgrey', 'PM2.5',100)
    plot_histogram(data['PM10'], 'plum', 'PM10',70)
