import sys
sys.path.append('src')
from json_class import JsonFileCreator
...
}  # insert your full JSON data here
    creator = JsonFileCreator(data_json, "ekvivalenter_data.json")
    creator.save_to_file()

    # Read part of the data
    data_subset = JsonFileCreator.data_reader("ekvivalenter_data.json", 20)
    print(data_subset)